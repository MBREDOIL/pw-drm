...
async def run_bot(bot: Client, m: Message):
    ...
    if user_id not in auth_users:
        await m.reply_text("**HEY BUDDY THIS IS ONLY FOR MY ADMINS TO USE THIS CONATCH MY DEV : @UIHASH  **")
    else:
            ...
            try:   
                ...
                if "drive" in url:
                    try:
                        ...
                        await copy.copy(chat_id = -1002494437539)
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
